...
const Home = () => {
    ...
    const { viewTaskModal, setViewTaskModal } = React.useContext(TaskModalContext!);
    ...
    return (
        <div className='w-full h-full grid grid-cols-1 grid-rows-[20rem 1fr] justify-items-center pb-32 lg:grid-cols-3 lg:col-span-1 lg:row-span-1 lg:pt-16 lg:pb-0'>
            ...
            <button className='w-3/5 h-12 bg-blue-600 justify-center items-center gap-4 text-xl text-white outline-none border-none hidden lg:flex' onClick={() => setViewTaskModal!(true)}>
